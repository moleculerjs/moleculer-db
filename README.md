...
| [moleculer-db-adapter-couchdb-nano](packages/moleculer-db-adapter-couchdb-nano#moleculer-db-adapter-couchdb-nano-) | [![NPM version](https://img.shields.io/npm/v/moleculer-db-adapter-couchdb-nano.svg)](https://www.npmjs.com/package/moleculer-db-adapter-sequelize) | CouchDB adapter for Moleculer DB service |
